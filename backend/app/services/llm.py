    ...
    async def generate_structured_advice(
        ...
        message_parts.extend(
            [
                ...
                '  "action_items": [',
                "    {",
                f'      "title": "简短的建议标题（10-30字）",',
                f'      "description": "详细的执行说明，包括具体方法、注意事项（50-200字）",',
                f'      "frequency": "执行频率，如：每天、每周3次、每餐前",',
                f'      "priority": "高/中/低",',
                f'      "risk_level": "低风险/中风险/高风险",',
                f'      "duration": "持续时间，格式为数字+单位，如：4周、3个月、长期"',
                "    }",
                "  ]",
                "}",
                "```",
