...
def detect_lipid_abnormality(
    blood_lipids: BloodLipids | None = None,
    *,
    ...
    return LipidAbnormalityResult(
        is_abnormal=len(abnormal_items) > 0, abnormal_items=abnormal_items, details=details
    )
...
def detect_glucose_abnormality(
    blood_glucose: BloodGlucose | None = None,
    *,
...
def _match_disease_category(disease_name: str) -> str | None:
    """
    根据疾病名称匹配禁忌病史类别
